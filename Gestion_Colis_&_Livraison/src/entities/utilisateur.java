...
public utilisateur( String type,int id) {
...
public utilisateur( String name,String password) {
    ...
    public String toString() {
        return "utilisateur{" + "id=" + id + ", nbr_point=" + nbr_point + ", name=" + name + ", lastname=" + lastname + ", adresse=" + adresse + ", email=" + email + ", type=" + type + ", password=" + password + ", birthdate=" + birthdate + ", code=" + code + '}';
    }
