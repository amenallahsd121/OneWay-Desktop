...
public class ModifierMaintenanceController implements Initializable {
    ...
    @FXML
    private void ModifierMaintenance(ActionEvent event) throws SQLException {
       // try {
            if (controleDeSaisie()) {
            ...
            notification(Main.getEtat(),"l'état de votre maintenance a été modifié avec succès",NotificationType.SUCCESS);
