 ...
 * @author amens
 */
public class AfficherColisFrontController implements Initializable {
  ...
  private static int id;
      public static int getIdd(int idd ) {
        
        id = idd;
          System.out.println(id+" Rani fel affichage");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try { 
            ...
            Logger.getLogger(AfficherColisFrontController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void AjouterColis(ActionEvent event) {
         ...
         gui.AjouterColisController.getIdUser(id);
         try {
