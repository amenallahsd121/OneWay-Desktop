 ...
 * @author amens
 */
public class SousBackOfficeOffreController implements Initializable {
 ...
 private void loadPage(String page)
    ...
    private void categorie(ActionEvent event) {
        loadPage("AffichageOffre");
        
    }

    @FXML
    private void vehicule(ActionEvent event) {
        loadPage("AffichageTrajetOffre");
    }

    @FXML
    private void maintenance(ActionEvent event) {
         loadPage("AffichageCategorieOffre");
    }
