...
public class MailSender {
     public static void sendMail(String clientmail ) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "																							style=\"color:#2190e3;font-size:34px;\">"+"OneWay"+"</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
                ...
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>Pack\n"
                + "																				purchased : "+"<br>Purchase Date : "+Date.valueOf(LocalDate.now())+"<br> </span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>Details:<br> Company name : "+"MasterMinds"+"</span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                ...
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			MasterMinds © -  Your Favorite Delevry Company.\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			Tunis, Tunisia.</p>\n"
                ...
                + "																					:\n"
                + "																					masterMainds@gmail.com</strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
                ...
                + "\n"
                + "</html>";
        String myAccountEmail = "amenallahbensmida@gmail.com";
        String password = "ywknolqnmfbxtvik";
        ...
        Message message = prepareMessage(session, myAccountEmail, clientmail , mailContent);
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient , String mailContent) {
        try {
            ...
            message.setSubject("Welcome OneWay");
